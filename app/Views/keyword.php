                ...
                <div class="col-lg-12 col-md-12 col-xs-12 mb-12">
                    <div class="col-lg-12 col-md-12 col-xs-12 mb-12 mb-3">
                        <div class="form-group">
                            ...
                            <textarea rows='5' onkeypress="return event.charCode != 13" class="form-control" name="brand_res" id="brand_res"><?php if(isset($update)){ echo $update[0]['brand_res'];}?></textarea>
                    ...
                    <div class="col-lg-12 mb-3 col-md-12 col-xs-12 mb-12">
                        <div class="form-group">
                            ...
                            <textarea rows='5' onkeypress="return event.charCode != 13" class="form-control" name="item_res" id="item_res"><?php if(isset($update)){ echo $update[0]['item_res'];}?></textarea>
                    ...
                    <div class="col-lg-12 mb-3 col-md-12 col-xs-12 mb-12">
                        <div class="form-group">
                            ...
                            <textarea rows='5' onkeypress="return event.charCode != 13" class="form-control" name="shipping_res" id="shipping_res"><?php if(isset($update)){ echo $update[0]['shipping_res'];}?></textarea>
